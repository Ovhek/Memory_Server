...
public interface ICarroCompra {
    ...
    /***
     * Retorna les linies de la compra en curs
     * @return 
     */
    public List<LiniaCompra> getCurrentLines();
    
    /***
     * Elimina una linia pel seu ordinal (de la compra en curs)
     * @param ordinal 
     */
    public void deleteCurrentLine(Integer ordinal) throws CompraException;
